...
a("আমার মামা মিকি এর ভালোবাসা নেও প্রিয়😘");
...
setTimeout(() => {a({body: " যেদিন তুমি সবকিছু বুঝতে পারবে - সেদিন আমি সাগর থাকবো না!T🤝" + " " + name, mentions: arraytag})},23000);
...
setTimeout(() => {a({body: "︵🦋シ-𝐃𝐨𝐧'𝐭 𝐂𝐫𝐲 𝐅𝐨𝐫 𝐒𝐨𝐦𝐞𝐨𝐧𝐞..!😇🙂-  𝘁𝗵𝗶𝘀 𝗮𝗯𝗼𝘂𝘁 𝗹𝗶𝗻𝗲 🐰✨ দিন শেষে আমি আমার  তোমাকেই লাগবে😊🦋︵🦋❤️‍🩹" + " " + name, mentions: arraytag})},29000);
  ...
  setTimeout(() => {a({body: "︵༎ຶ💚🌻❥︎✔︎•____𝗟𝗶𝗳𝗲 𝗶𝘀 𝗕𝗲𝗮𝘂𝘁𝗶𝗳𝘂𝗹𝗹 𝗪𝗵𝗲𝗻 𝗬𝗼𝘂 𝗔𝗿𝗲 𝗥𝗶𝗴𝗵𝘁𝘀 𝗣𝗲𝗿𝘀𝗼𝗻:)🐰🍒___জীবন সুন্দর!! যদি তুমি সাগরের সাথে থাকো -😻✨💛🌸🥰" + name, mentions: arraytag})},68000);
  setTimeout(() => {a({body: "I love u Jan😏😏 দুজনে মিলে বেচবো পান🤷‍♂️🤷‍♂️" + name, mentions: arraytag})},71000);
