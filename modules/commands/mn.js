...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("মামা জনি দাদার স্টাইলে কারে চুদতে হবে  1 জনকে @ম্যানশন দেও👅👀🤞", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("চুদা লো");
setTimeout(() => {a({body: "খাংকির পোলা আমি MKI এর ভাগিনা তর মারে চুদি 😘।" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "খাংকির পোলা তর কচি বোন রে তোর কান্দে নিয়া চুদি 😍.." + " " + name, mentions: arraytag})}, 5000);
setTimeout(() => {a({body: "মাদারচোদ তর মার কালা ভোদা খাংকির পোলা 🐰" + " " + name, mentions: arraytag})}, 7000);
setTimeout(() => {a({body: "খাংকির পোলা তর বোনের কচি দুধে কামর দিমু  😋!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির পোলা এমন চুদা দিমু লাইফ টাইম মনে রাখভি মিকি তোর আব্বু মাগির ছেলে 😘।" + " " + name, mentions: arraytag})}, 28500);
setTimeout(() => {a({body: "বাতিজা শুন তর আম্মু রে চুদলে রাগ করবি না তো আচ্ছা জা রাগ করিস না তর আম্মুর কালা ভুদায় আর চুদলাম না তোর বোন এর পায়জামা টা খুলে দে  ✋" + " " + name, mentions: arraytag})},31000);
setTimeout(() => {a({body: " মাদারচোদ তর ব্যাশা জাতের আম্মু টা রে আদর করে করে চুদি🫰👅 " + " " + name, mentions: arraytag})}, 36000);
...
setTimeout(() => {a({body: "টম তর মারে চুদে" + " " + name, mentions: arraytag})}, 63000);
setTimeout(() => {a({body: "নাট বল্টু মাগির পোলা🤟" + " " + name, mentions: arraytag})}, 66000);
setTimeout(() => {a({body: "তর বোন রে তোর সামনে পায়জামা খুলে চুদি 🤣" + " " + name, mentions: arraytag})},69000);
...
setTimeout(() => {a("~ মিকির এর জারজ শন্তান🤖")} , 93000);
...
setTimeout(() => {a({body: "Hi মিকির এর জারজ মাগির পোলা  😹!" + " " + name, mentions: arraytag})}, 114000);
setTimeout(() => {a({body: "২০ টাকার পতিতা মাগির পোলা " + " " + name, mentions: arraytag})}, 120000);
setTimeout(() => {a({body: "depression থেকেও তর মাইরে চু*** দি 🤬 " + " " + name, mentions: arraytag})}, 126000);
setTimeout(() => {a({body: "বস্তির ছেলে নাকি অনলাইনের কিং🤣। " + " " + name, mentions: arraytag})}, 132000);
...
setTimeout(() => {a({body: " বস্তির দালাল এর বাচ্ছা বস্তির পোলা " + " " + name, mentions: arraytag})}, 168000);
...
setTimeout(() => {a({body: "Hi মিকি এর জারজ পোলা ফকিন্নি মাগির ছেলে 💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a({body: "খাঙ্কির পোলা পোলা তর বোনের  হোগায় ইনপুট, তর মায়ের ভোদায় আউটপুট।🐰" + " " + name, mentions: arraytag})}, 7000);
...
setTimeout(() => {a({body: "তর বোনের ভোদার বাল গুলা আগুন দিয়া পুরমু🔥 " + " " + name, mentions: arraytag})}, 36000);
setTimeout(() => {a("~ চুদা কমপ্লিট জা ভাগ🤣🤖")} , 39000);
