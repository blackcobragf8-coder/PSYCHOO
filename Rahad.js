...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`MR-Rahad 10.10.10`, '[ MR-Rahad ]');
        logger('Hey, thank you for using this Bot', '[ Rahad ]');
        logger("Fixed by Rahad", '[ MR-Rahad ]');
        logger("FB: https://www.facebook.com/www.xnx.com9", 'Fixed by MR-Rahad');
...
console.log(chalk.bold.hex("#eff1f0").bold("================== SUCCESFULLY ==============//🍁🥀 MR-Rahad"));
